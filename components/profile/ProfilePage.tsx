...
export default function ProfilePage() {
  ...
  const getRecommendations = () => {
    ...
    const expLacksNumbers = extractedData.experience?.some(exp => {
      const text = (exp.description || "") + (exp.bullets?.join(" ") || "");
    ...
    if (!extractedData.linkedin && !extractedData.github && !extractedData.portfolio) {
      recs.push({
        id: "links",
            ...
            <div className="clean-card">
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 14, marginBottom: 24 }}>
                {[
                  ...
                  { label: "Add professional links", points: 10, done: !!(extractedData.linkedin || extractedData.github || extractedData.portfolio) },
