...
// All candidate personas and employment histories below are fictional examples.
export const RESUME_EXAMPLES_DATA = [
    ...
    } as unknown as TBResumeData  },
  {
    ...
    data: {
      ...
      customSections: [],
      profile: {
        name: "Anika Reddy", email: "anika.reddy@example.com", phone: "", location: "Charlotte, NC", website: "", linkedin: "", github: "", summary: "Certified Nurse Practitioner specializing in geriatric telemedicine, with a strong background in patient-centered care and interdisciplinary team leadership."
      },
      workExperiences: [
        { id: crypto.randomUUID(), company: "Carolina Geriatric Partners", jobTitle: "Certified Nurse Practitioner", location: "", startDate: "2018", endDate: "Present", current: true, bullets: "Conduct patient assessments and develop treatment plans under applicable North Carolina collaborative-practice requirements\\nLead interdisciplinary team managing complex chronic care cases\\nExpanded telemedicine services, increasing rural patient access by 45%" }, { id: crypto.randomUUID(), company: "Piedmont Family Health", jobTitle: "Registered Nurse", location: "", startDate: "2013", endDate: "2018", current: false, bullets: "Provided primary care support for a family medicine practice serving 1,000+ patients\\nCoordinated referrals and follow-up care across specialty providers" }
      ],
      educations: [
