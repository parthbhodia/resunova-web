...
export function ProfessionalTemplate({ data, onEditField, HoverWrapper }: TemplateProps) {
  ...
  return (
    <div style={{
      ...
      <div style={{ textAlign: "center", marginBottom: "24px" }}>
        <h1 style={{ fontSize: "24pt", fontWeight: "normal", margin: "0 0 8px 0", color: "#000" }}>
      ...
      <div style={{ borderBottom: `2px solid ${customization.accentColor}`, marginBottom: "32px" }} />
      ...
      <div style={{ marginBottom: "32px", whiteSpace: "pre-wrap" }}>
        ...
        <Wrapper field="recipient">
          ...
          {recipient.roleTitle && <div>{recipient.roleTitle} Hiring Team</div>}
      ...
      <div style={{ marginTop: "32px" }}>
        <div style={{ marginBottom: "24px" }}>Sincerely,</div>
