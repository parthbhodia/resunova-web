...
export function MadonaTemplate({ data, HoverWrapper }: TemplateProps) {
  ...
  return (
    <div style={{
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "16px" }}>
        {/* Left: Name & Title */}
        <div>
          <h1 style={{ fontSize: "24pt", fontWeight: "600", textTransform: "uppercase", letterSpacing: "1px", margin: "0 0 4px 0", color: "#111827" }}>
            <Wrapper field="author.name">{author.name || "Your Name"}</Wrapper>
          </h1>
          {recipient.roleTitle && (
            <div style={{ fontSize: "12pt", fontWeight: "500", color: "#4b5563" }}>
      ...
      <div style={{ borderBottom: "3px solid #d1d5db", marginBottom: "4px" }} />
      <div style={{ borderBottom: "1px solid #d1d5db", marginBottom: "32px" }} />
